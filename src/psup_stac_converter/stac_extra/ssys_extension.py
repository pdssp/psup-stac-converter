...
class SolSysExtension(
    ...
    def apply(
        ...
        Args:
            targets : Array to hold list of target bodies (e.g. Mars, Moon, Earth) conforming
                to the `International Virtual Observatory Alliance<https://www.ivoa.net/documents/EPNTAP/20220822/REC-EPNTAP-2.0.html#tth_sEc2.1.3>`_
    ...
    def local_time(self) -> str | None:
        ...
        It is unlikley that this time should be something like the SpacecraftClockCount
    ...
    def target_class(self) -> SolSysTargetClass | None:
        ...
        Solar System bodies are defined without ambiguity by the couple target_class and target_name.
        Values for this class are derived from the `International Virtual Observatory Alliance <https://www.ivoa.net/documents/EPNTAP/20220822/REC-EPNTAP-2.0.html#tth_sEc2.1.3>`__target
